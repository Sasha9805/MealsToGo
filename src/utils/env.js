...
const liveHostPay = "https://pay-jxy6fwwzra-uc.a.run.app";
const localHostPay = "http://127.0.0.1:5001/mealstogo-e7267/us-central1/pay";
...
export const hostPay = !isDevelopment || isAndroid ? liveHostPay : localHostPay;
